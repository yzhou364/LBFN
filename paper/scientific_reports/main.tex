...
The Python implementation of the LBFN model and all baseline solvers, together with the scripts and data that reproduce the numerical experiments and figures reported in this study, are available in the GitHub repository at \url{https://github.com/yzhou364/LBFN}.
