...
\subfigure[]{\includegraphics[width=58mm,height=46mm]{coeff_x1.eps}}
\subfigure[]{\includegraphics[width=58mm,height=46mm]{coeff_x2.eps}}
\subfigure[]{\includegraphics[width=58mm,height=46mm]{coeff_g1.eps}}
\subfigure[]{\includegraphics[width=58mm,height=46mm]{coeff_g2.eps}}
\subfigure[]{\includegraphics[width=58mm,height=46mm]{coeff_err1.eps}}
\subfigure[]{\includegraphics[width=58mm,height=46mm]{coeff_err2.eps}}
...
\begin{figure*}[thbp]\centering
\subfigure[]{\includegraphics[width=58mm,height=46mm]{init_x1.eps}}
\subfigure[]{\includegraphics[width=58mm,height=46mm]{init_x2.eps}}
\subfigure[]{\includegraphics[width=58mm,height=46mm]{init_g1.eps}}
\subfigure[]{\includegraphics[width=58mm,height=46mm]{init_g2.eps}}
\subfigure[]{\includegraphics[width=58mm,height=46mm]{init_err1.eps}}
\subfigure[]{\includegraphics[width=58mm,height=46mm]{init_err2.eps}}
...
\begin{figure*}[thbp]\centering
\subfigure[]{\includegraphics[width=58mm,height=46mm]{comp_x1.eps}}
\subfigure[]{\includegraphics[width=58mm,height=46mm]{comp_x2.eps}}
\subfigure[]{\includegraphics[width=58mm,height=46mm]{comp_g1.eps}}
\subfigure[]{\includegraphics[width=58mm,height=46mm]{comp_g2.eps}}
\subfigure[]{\includegraphics[width=58mm,height=46mm]{comp_err1.eps}}
\subfigure[]{\includegraphics[width=58mm,height=46mm]{comp_err2.eps}}
...
\begin{figure*}[thbp]\centering
\subfigure[]{\includegraphics[width=40mm,height=34mm]{t10_motion.eps}}
\subfigure[]{\includegraphics[width=40mm,height=34mm]{t10_contour.eps}}
\subfigure[]{\includegraphics[width=40mm,height=34mm]{t10_land.eps}}
\subfigure[]{\includegraphics[width=40mm,height=34mm]{t20_motion.eps}}
\subfigure[]{\includegraphics[width=40mm,height=34mm]{t20_contour.eps}}
\subfigure[]{\includegraphics[width=40mm,height=34mm]{t20_land.eps}}
\subfigure[]{\includegraphics[width=40mm,height=34mm]{t30_motion.eps}}
\subfigure[]{\includegraphics[width=40mm,height=34mm]{t30_contour.eps}}
\subfigure[]{\includegraphics[width=40mm,height=34mm]{t30_land.eps}}
...
\item \textbf{Availability of data and materials:} The numerical simulation code and data supporting the findings of this study are available from the corresponding author upon reasonable request.
\item \textbf{Code availability:} The MATLAB/Python implementation of the LBFN model is available from the corresponding author upon reasonable request.
...
\item \textbf{Use of AI:} [DRAFT -- authors: replace with an accurate account before submission, per the journal's AI-use policy.] An AI assistant (Claude, Anthropic) was used to implement the numerical simulation code, execute the numerical experiments reported in Section~\ref{sec4}, and assist with drafting and revising the manuscript text. The authors designed the study, verified the correctness of the implementation and results, and take full responsibility for the content of this manuscript.
\end{itemize}
